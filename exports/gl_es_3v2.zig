...
pub fn load(load_ctx: anytype, get_proc_address: fn (@TypeOf(load_ctx), [:0]const u8) ?*const anyopaque) !void {
    ...
    if (get_proc_address(load_ctx, "glBlendBarrier")) |proc| {
        function_pointers.glBlendBarrier = @ptrCast(@TypeOf(function_pointers.glBlendBarrier), proc);
    } else {
    ...
    if (get_proc_address(load_ctx, "glPrimitiveBoundingBox")) |proc| {
        function_pointers.glPrimitiveBoundingBox = @ptrCast(@TypeOf(function_pointers.glPrimitiveBoundingBox), proc);
    } else {
...
const function_pointers = struct {
    ...
    var glBlendBarrier: ?FnPtr(function_signatures.glBlendBarrier) = null;
    ...
    var glPrimitiveBoundingBox: ?FnPtr(function_signatures.glPrimitiveBoundingBox) = null;
