...
pub fn primitiveBoundingBox(_minX: GLfloat, _minY: GLfloat, _minZ: GLfloat, _minW: GLfloat, _maxX: GLfloat, _maxY: GLfloat, _maxZ: GLfloat, _maxW: GLfloat) void {
    return (function_pointers.glPrimitiveBoundingBox orelse @panic("glPrimitiveBoundingBox was not bound."))(_minX, _minY, _minZ, _minW, _maxX, _maxY, _maxZ, _maxW);
}
...
const function_signatures = struct {
    ...
    const glPrimitiveBoundingBox = fn (_minX: GLfloat, _minY: GLfloat, _minZ: GLfloat, _minW: GLfloat, _maxX: GLfloat, _maxY: GLfloat, _maxZ: GLfloat, _maxW: GLfloat) void;
