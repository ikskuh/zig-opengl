...
pub fn textureView(texture: GLuint, target: GLenum, origtexture: GLuint, internalformat: GLenum, minlevel: GLuint, numlevels: GLuint, minlayer: GLuint, numlayers: GLuint) void {
    return (function_pointers.glTextureView orelse @panic("glTextureView was not bound."))(texture, target, origtexture, internalformat, minlevel, numlevels, minlayer, numlayers);
}
...
pub fn vertexAttribLFormat(attribindex: GLuint, size: GLint, type: GLenum, relativeoffset: GLuint) void {
    return (function_pointers.glVertexAttribLFormat orelse @panic("glVertexAttribLFormat was not bound."))(attribindex, size, type, relativeoffset);
}
...
pub fn bufferStorage(target: GLenum, size: GLsizeiptr, data: *const c_void, flags: GLbitfield) void {
    return (function_pointers.glBufferStorage orelse @panic("glBufferStorage was not bound."))(target, size, data, flags);
}

pub fn clearTexImage(texture: GLuint, level: GLint, format: GLenum, type: GLenum, data: *const c_void) void {
    return (function_pointers.glClearTexImage orelse @panic("glClearTexImage was not bound."))(texture, level, format, type, data);
}

pub fn clearTexSubImage(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, type: GLenum, data: *const c_void) void {
    return (function_pointers.glClearTexSubImage orelse @panic("glClearTexSubImage was not bound."))(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data);
}

pub fn bindBuffersBase(target: GLenum, first: GLuint, count: GLsizei, buffers: [*c]const GLuint) void {
    return (function_pointers.glBindBuffersBase orelse @panic("glBindBuffersBase was not bound."))(target, first, count, buffers);
}

pub fn bindBuffersRange(target: GLenum, first: GLuint, count: GLsizei, buffers: [*c]const GLuint, offsets: [*c]const GLintptr, sizes: [*c]const GLsizeiptr) void {
    return (function_pointers.glBindBuffersRange orelse @panic("glBindBuffersRange was not bound."))(target, first, count, buffers, offsets, sizes);
}

pub fn bindTextures(first: GLuint, count: GLsizei, textures: [*c]const GLuint) void {
    return (function_pointers.glBindTextures orelse @panic("glBindTextures was not bound."))(first, count, textures);
}

pub fn bindSamplers(first: GLuint, count: GLsizei, samplers: [*c]const GLuint) void {
    return (function_pointers.glBindSamplers orelse @panic("glBindSamplers was not bound."))(first, count, samplers);
}

pub fn bindImageTextures(first: GLuint, count: GLsizei, textures: [*c]const GLuint) void {
    return (function_pointers.glBindImageTextures orelse @panic("glBindImageTextures was not bound."))(first, count, textures);
}

pub fn bindVertexBuffers(first: GLuint, count: GLsizei, buffers: [*c]const GLuint, offsets: [*c]const GLintptr, strides: [*c]const GLsizei) void {
    return (function_pointers.glBindVertexBuffers orelse @panic("glBindVertexBuffers was not bound."))(first, count, buffers, offsets, strides);
}

pub fn clipControl(origin: GLenum, depth: GLenum) void {
    return (function_pointers.glClipControl orelse @panic("glClipControl was not bound."))(origin, depth);
}
...
pub fn getTextureSubImage(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, type: GLenum, bufSize: GLsizei, pixels: *c_void) void {
    return (function_pointers.glGetTextureSubImage orelse @panic("glGetTextureSubImage was not bound."))(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bufSize, pixels);
}

pub fn getCompressedTextureSubImage(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, bufSize: GLsizei, pixels: *c_void) void {
    return (function_pointers.glGetCompressedTextureSubImage orelse @panic("glGetCompressedTextureSubImage was not bound."))(texture, level, xoffset, yoffset, zoffset, width, height, depth, bufSize, pixels);
}
...
pub fn getnCompressedTexImage(target: GLenum, lod: GLint, bufSize: GLsizei, pixels: *c_void) void {
    return (function_pointers.glGetnCompressedTexImage orelse @panic("glGetnCompressedTexImage was not bound."))(target, lod, bufSize, pixels);
}

pub fn getnTexImage(target: GLenum, level: GLint, format: GLenum, type: GLenum, bufSize: GLsizei, pixels: *c_void) void {
    return (function_pointers.glGetnTexImage orelse @panic("glGetnTexImage was not bound."))(target, level, format, type, bufSize, pixels);
}

pub fn getnUniformdv(program: GLuint, location: GLint, bufSize: GLsizei, params: [*c]GLdouble) void {
    return (function_pointers.glGetnUniformdv orelse @panic("glGetnUniformdv was not bound."))(program, location, bufSize, params);
}
...
pub fn getnMapdv(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLdouble) void {
    return (function_pointers.glGetnMapdv orelse @panic("glGetnMapdv was not bound."))(target, query, bufSize, v);
}

pub fn getnMapfv(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLfloat) void {
    return (function_pointers.glGetnMapfv orelse @panic("glGetnMapfv was not bound."))(target, query, bufSize, v);
}

pub fn getnMapiv(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLint) void {
    return (function_pointers.glGetnMapiv orelse @panic("glGetnMapiv was not bound."))(target, query, bufSize, v);
}

pub fn getnPixelMapfv(map: GLenum, bufSize: GLsizei, values: [*c]GLfloat) void {
    return (function_pointers.glGetnPixelMapfv orelse @panic("glGetnPixelMapfv was not bound."))(map, bufSize, values);
}

pub fn getnPixelMapuiv(map: GLenum, bufSize: GLsizei, values: [*c]GLuint) void {
    return (function_pointers.glGetnPixelMapuiv orelse @panic("glGetnPixelMapuiv was not bound."))(map, bufSize, values);
}

pub fn getnPixelMapusv(map: GLenum, bufSize: GLsizei, values: [*c]GLushort) void {
    return (function_pointers.glGetnPixelMapusv orelse @panic("glGetnPixelMapusv was not bound."))(map, bufSize, values);
}

pub fn getnPolygonStipple(bufSize: GLsizei, pattern: [*c]GLubyte) void {
    return (function_pointers.glGetnPolygonStipple orelse @panic("glGetnPolygonStipple was not bound."))(bufSize, pattern);
}

pub fn getnColorTable(target: GLenum, format: GLenum, type: GLenum, bufSize: GLsizei, table: *c_void) void {
    return (function_pointers.glGetnColorTable orelse @panic("glGetnColorTable was not bound."))(target, format, type, bufSize, table);
}

pub fn getnConvolutionFilter(target: GLenum, format: GLenum, type: GLenum, bufSize: GLsizei, image: *c_void) void {
    return (function_pointers.glGetnConvolutionFilter orelse @panic("glGetnConvolutionFilter was not bound."))(target, format, type, bufSize, image);
}

pub fn getnSeparableFilter(target: GLenum, format: GLenum, type: GLenum, rowBufSize: GLsizei, row: *c_void, columnBufSize: GLsizei, column: *c_void, span: *c_void) void {
    return (function_pointers.glGetnSeparableFilter orelse @panic("glGetnSeparableFilter was not bound."))(target, format, type, rowBufSize, row, columnBufSize, column, span);
}

pub fn getnHistogram(target: GLenum, reset: GLboolean, format: GLenum, type: GLenum, bufSize: GLsizei, values: *c_void) void {
    return (function_pointers.glGetnHistogram orelse @panic("glGetnHistogram was not bound."))(target, reset, format, type, bufSize, values);
}

pub fn getnMinmax(target: GLenum, reset: GLboolean, format: GLenum, type: GLenum, bufSize: GLsizei, values: *c_void) void {
    return (function_pointers.glGetnMinmax orelse @panic("glGetnMinmax was not bound."))(target, reset, format, type, bufSize, values);
}
...
pub fn specializeShader(shader: GLuint, pEntryPoint: [*c]const GLchar, numSpecializationConstants: GLuint, pConstantIndex: [*c]const GLuint, pConstantValue: [*c]const GLuint) void {
    return (function_pointers.glSpecializeShader orelse @panic("glSpecializeShader was not bound."))(shader, pEntryPoint, numSpecializationConstants, pConstantIndex, pConstantValue);
}

pub fn multiDrawArraysIndirectCount(mode: GLenum, indirect: *const c_void, drawcount: GLintptr, maxdrawcount: GLsizei, stride: GLsizei) void {
    return (function_pointers.glMultiDrawArraysIndirectCount orelse @panic("glMultiDrawArraysIndirectCount was not bound."))(mode, indirect, drawcount, maxdrawcount, stride);
}

pub fn multiDrawElementsIndirectCount(mode: GLenum, type: GLenum, indirect: *const c_void, drawcount: GLintptr, maxdrawcount: GLsizei, stride: GLsizei) void {
    return (function_pointers.glMultiDrawElementsIndirectCount orelse @panic("glMultiDrawElementsIndirectCount was not bound."))(mode, type, indirect, drawcount, maxdrawcount, stride);
}

pub fn polygonOffsetClamp(factor: GLfloat, units: GLfloat, clamp: GLfloat) void {
    return (function_pointers.glPolygonOffsetClamp orelse @panic("glPolygonOffsetClamp was not bound."))(factor, units, clamp);
}
...
pub fn load(load_ctx: anytype, get_proc_address: fn(@TypeOf(load_ctx), [:0]const u8) ?*c_void) !void {
    ...
    if(get_proc_address(load_ctx, "glTextureView")) |proc| {
        ...
        log.emerg("entry point glTextureView not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glVertexAttribLFormat")) |proc| {
        ...
        log.emerg("entry point glVertexAttribLFormat not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glBufferStorage")) |proc| {
        ...
        log.emerg("entry point glBufferStorage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glClearTexImage")) |proc| {
        ...
        log.emerg("entry point glClearTexImage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glClearTexSubImage")) |proc| {
        ...
        log.emerg("entry point glClearTexSubImage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindBuffersBase")) |proc| {
        ...
        log.emerg("entry point glBindBuffersBase not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindBuffersRange")) |proc| {
        ...
        log.emerg("entry point glBindBuffersRange not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindTextures")) |proc| {
        ...
        log.emerg("entry point glBindTextures not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindSamplers")) |proc| {
        ...
        log.emerg("entry point glBindSamplers not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindImageTextures")) |proc| {
        ...
        log.emerg("entry point glBindImageTextures not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glBindVertexBuffers")) |proc| {
        ...
        log.emerg("entry point glBindVertexBuffers not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glClipControl")) |proc| {
        function_pointers.glClipControl = @ptrCast(?function_signatures.glClipControl,  proc);
    } else {
        log.emerg("entry point glClipControl not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glGetTextureSubImage")) |proc| {
        function_pointers.glGetTextureSubImage = @ptrCast(?function_signatures.glGetTextureSubImage,  proc);
    } else {
        log.emerg("entry point glGetTextureSubImage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetCompressedTextureSubImage")) |proc| {
        function_pointers.glGetCompressedTextureSubImage = @ptrCast(?function_signatures.glGetCompressedTextureSubImage,  proc);
    } else {
        log.emerg("entry point glGetCompressedTextureSubImage not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glGetnCompressedTexImage")) |proc| {
        function_pointers.glGetnCompressedTexImage = @ptrCast(?function_signatures.glGetnCompressedTexImage,  proc);
    } else {
        log.emerg("entry point glGetnCompressedTexImage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnTexImage")) |proc| {
        function_pointers.glGetnTexImage = @ptrCast(?function_signatures.glGetnTexImage,  proc);
    } else {
        log.emerg("entry point glGetnTexImage not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnUniformdv")) |proc| {
        function_pointers.glGetnUniformdv = @ptrCast(?function_signatures.glGetnUniformdv,  proc);
    } else {
        log.emerg("entry point glGetnUniformdv not found!", .{});
        success = false;
    }
    ...
    if(get_proc_address(load_ctx, "glGetnMapdv")) |proc| {
        function_pointers.glGetnMapdv = @ptrCast(?function_signatures.glGetnMapdv,  proc);
    } else {
        log.emerg("entry point glGetnMapdv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnMapfv")) |proc| {
        function_pointers.glGetnMapfv = @ptrCast(?function_signatures.glGetnMapfv,  proc);
    } else {
        log.emerg("entry point glGetnMapfv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnMapiv")) |proc| {
        function_pointers.glGetnMapiv = @ptrCast(?function_signatures.glGetnMapiv,  proc);
    } else {
        log.emerg("entry point glGetnMapiv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnPixelMapfv")) |proc| {
        function_pointers.glGetnPixelMapfv = @ptrCast(?function_signatures.glGetnPixelMapfv,  proc);
    } else {
        log.emerg("entry point glGetnPixelMapfv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnPixelMapuiv")) |proc| {
        function_pointers.glGetnPixelMapuiv = @ptrCast(?function_signatures.glGetnPixelMapuiv,  proc);
    } else {
        log.emerg("entry point glGetnPixelMapuiv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnPixelMapusv")) |proc| {
        function_pointers.glGetnPixelMapusv = @ptrCast(?function_signatures.glGetnPixelMapusv,  proc);
    } else {
        log.emerg("entry point glGetnPixelMapusv not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnPolygonStipple")) |proc| {
        function_pointers.glGetnPolygonStipple = @ptrCast(?function_signatures.glGetnPolygonStipple,  proc);
    } else {
        log.emerg("entry point glGetnPolygonStipple not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnColorTable")) |proc| {
        function_pointers.glGetnColorTable = @ptrCast(?function_signatures.glGetnColorTable,  proc);
    } else {
        log.emerg("entry point glGetnColorTable not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnConvolutionFilter")) |proc| {
        function_pointers.glGetnConvolutionFilter = @ptrCast(?function_signatures.glGetnConvolutionFilter,  proc);
    } else {
        log.emerg("entry point glGetnConvolutionFilter not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnSeparableFilter")) |proc| {
        function_pointers.glGetnSeparableFilter = @ptrCast(?function_signatures.glGetnSeparableFilter,  proc);
    } else {
        log.emerg("entry point glGetnSeparableFilter not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnHistogram")) |proc| {
        function_pointers.glGetnHistogram = @ptrCast(?function_signatures.glGetnHistogram,  proc);
    } else {
        log.emerg("entry point glGetnHistogram not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glGetnMinmax")) |proc| {
        function_pointers.glGetnMinmax = @ptrCast(?function_signatures.glGetnMinmax,  proc);
    } else {
        log.emerg("entry point glGetnMinmax not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glTextureBarrier")) |proc| {
        function_pointers.glTextureBarrier = @ptrCast(?function_signatures.glTextureBarrier,  proc);
    } else {
        log.emerg("entry point glTextureBarrier not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glSpecializeShader")) |proc| {
        function_pointers.glSpecializeShader = @ptrCast(?function_signatures.glSpecializeShader,  proc);
    } else {
        log.emerg("entry point glSpecializeShader not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glMultiDrawArraysIndirectCount")) |proc| {
        function_pointers.glMultiDrawArraysIndirectCount = @ptrCast(?function_signatures.glMultiDrawArraysIndirectCount,  proc);
    } else {
        log.emerg("entry point glMultiDrawArraysIndirectCount not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glMultiDrawElementsIndirectCount")) |proc| {
        function_pointers.glMultiDrawElementsIndirectCount = @ptrCast(?function_signatures.glMultiDrawElementsIndirectCount,  proc);
    } else {
        log.emerg("entry point glMultiDrawElementsIndirectCount not found!", .{});
        success = false;
    }
    if(get_proc_address(load_ctx, "glPolygonOffsetClamp")) |proc| {
        function_pointers.glPolygonOffsetClamp = @ptrCast(?function_signatures.glPolygonOffsetClamp,  proc);
    } else {
        log.emerg("entry point glPolygonOffsetClamp not found!", .{});
        success = false;
    }
    if(!success)
...
const function_signatures = struct {
    ...
    const glVertexAttribLFormat = fn(attribindex: GLuint, size: GLint, type: GLenum, relativeoffset: GLuint) void;
    ...
    const glBufferStorage = fn(target: GLenum, size: GLsizeiptr, data: *const c_void, flags: GLbitfield) void;
    const glClearTexImage = fn(texture: GLuint, level: GLint, format: GLenum, type: GLenum, data: *const c_void) void;
    const glClearTexSubImage = fn(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, type: GLenum, data: *const c_void) void;
    const glBindBuffersBase = fn(target: GLenum, first: GLuint, count: GLsizei, buffers: [*c]const GLuint) void;
    const glBindBuffersRange = fn(target: GLenum, first: GLuint, count: GLsizei, buffers: [*c]const GLuint, offsets: [*c]const GLintptr, sizes: [*c]const GLsizeiptr) void;
    const glBindTextures = fn(first: GLuint, count: GLsizei, textures: [*c]const GLuint) void;
    const glBindSamplers = fn(first: GLuint, count: GLsizei, samplers: [*c]const GLuint) void;
    const glBindImageTextures = fn(first: GLuint, count: GLsizei, textures: [*c]const GLuint) void;
    const glBindVertexBuffers = fn(first: GLuint, count: GLsizei, buffers: [*c]const GLuint, offsets: [*c]const GLintptr, strides: [*c]const GLsizei) void;
    const glClipControl = fn(origin: GLenum, depth: GLenum) void;
    ...
    const glGetTextureSubImage = fn(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, type: GLenum, bufSize: GLsizei, pixels: *c_void) void;
    const glGetCompressedTextureSubImage = fn(texture: GLuint, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, bufSize: GLsizei, pixels: *c_void) void;
    const glGetGraphicsResetStatus = fn() GLenum;
    const glGetnCompressedTexImage = fn(target: GLenum, lod: GLint, bufSize: GLsizei, pixels: *c_void) void;
    const glGetnTexImage = fn(target: GLenum, level: GLint, format: GLenum, type: GLenum, bufSize: GLsizei, pixels: *c_void) void;
    const glGetnUniformdv = fn(program: GLuint, location: GLint, bufSize: GLsizei, params: [*c]GLdouble) void;
    ...
    const glGetnMapdv = fn(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLdouble) void;
    const glGetnMapfv = fn(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLfloat) void;
    const glGetnMapiv = fn(target: GLenum, query: GLenum, bufSize: GLsizei, v: [*c]GLint) void;
    const glGetnPixelMapfv = fn(map: GLenum, bufSize: GLsizei, values: [*c]GLfloat) void;
    const glGetnPixelMapuiv = fn(map: GLenum, bufSize: GLsizei, values: [*c]GLuint) void;
    const glGetnPixelMapusv = fn(map: GLenum, bufSize: GLsizei, values: [*c]GLushort) void;
    const glGetnPolygonStipple = fn(bufSize: GLsizei, pattern: [*c]GLubyte) void;
    const glGetnColorTable = fn(target: GLenum, format: GLenum, type: GLenum, bufSize: GLsizei, table: *c_void) void;
    const glGetnConvolutionFilter = fn(target: GLenum, format: GLenum, type: GLenum, bufSize: GLsizei, image: *c_void) void;
    const glGetnSeparableFilter = fn(target: GLenum, format: GLenum, type: GLenum, rowBufSize: GLsizei, row: *c_void, columnBufSize: GLsizei, column: *c_void, span: *c_void) void;
    const glGetnHistogram = fn(target: GLenum, reset: GLboolean, format: GLenum, type: GLenum, bufSize: GLsizei, values: *c_void) void;
    const glGetnMinmax = fn(target: GLenum, reset: GLboolean, format: GLenum, type: GLenum, bufSize: GLsizei, values: *c_void) void;
    const glTextureBarrier = fn() void;
    const glSpecializeShader = fn(shader: GLuint, pEntryPoint: [*c]const GLchar, numSpecializationConstants: GLuint, pConstantIndex: [*c]const GLuint, pConstantValue: [*c]const GLuint) void;
    const glMultiDrawArraysIndirectCount = fn(mode: GLenum, indirect: *const c_void, drawcount: GLintptr, maxdrawcount: GLsizei, stride: GLsizei) void;
    const glMultiDrawElementsIndirectCount = fn(mode: GLenum, type: GLenum, indirect: *const c_void, drawcount: GLintptr, maxdrawcount: GLsizei, stride: GLsizei) void;
    const glPolygonOffsetClamp = fn(factor: GLfloat, units: GLfloat, clamp: GLfloat) void;
};
...
const function_pointers = struct {
    ...
    var glClipControl: ?function_signatures.glClipControl = null;
    ...
    var glGetTextureSubImage: ?function_signatures.glGetTextureSubImage = null;
    var glGetCompressedTextureSubImage: ?function_signatures.glGetCompressedTextureSubImage = null;
    var glGetGraphicsResetStatus: ?function_signatures.glGetGraphicsResetStatus = null;
    var glGetnCompressedTexImage: ?function_signatures.glGetnCompressedTexImage = null;
    var glGetnTexImage: ?function_signatures.glGetnTexImage = null;
    var glGetnUniformdv: ?function_signatures.glGetnUniformdv = null;
    ...
    var glGetnMapdv: ?function_signatures.glGetnMapdv = null;
    var glGetnMapfv: ?function_signatures.glGetnMapfv = null;
    var glGetnMapiv: ?function_signatures.glGetnMapiv = null;
    var glGetnPixelMapfv: ?function_signatures.glGetnPixelMapfv = null;
    var glGetnPixelMapuiv: ?function_signatures.glGetnPixelMapuiv = null;
    var glGetnPixelMapusv: ?function_signatures.glGetnPixelMapusv = null;
    var glGetnPolygonStipple: ?function_signatures.glGetnPolygonStipple = null;
    var glGetnColorTable: ?function_signatures.glGetnColorTable = null;
    var glGetnConvolutionFilter: ?function_signatures.glGetnConvolutionFilter = null;
    var glGetnSeparableFilter: ?function_signatures.glGetnSeparableFilter = null;
    var glGetnHistogram: ?function_signatures.glGetnHistogram = null;
    var glGetnMinmax: ?function_signatures.glGetnMinmax = null;
    var glTextureBarrier: ?function_signatures.glTextureBarrier = null;
    var glSpecializeShader: ?function_signatures.glSpecializeShader = null;
    var glMultiDrawArraysIndirectCount: ?function_signatures.glMultiDrawArraysIndirectCount = null;
    var glMultiDrawElementsIndirectCount: ?function_signatures.glMultiDrawElementsIndirectCount = null;
    var glPolygonOffsetClamp: ?function_signatures.glPolygonOffsetClamp = null;
};
