...
pub fn multiDrawArraysIndirectCount(_mode: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) void {
...
pub fn multiDrawElementsIndirectCount(_mode: GLenum, _type: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) void {
...
const function_signatures = struct {
    ...
    const glMultiDrawArraysIndirectCount = fn (_mode: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) void;
    const glMultiDrawElementsIndirectCount = fn (_mode: GLenum, _type: GLenum, _indirect: ?*const anyopaque, _drawcount: GLintptr, _maxdrawcount: GLsizei, _stride: GLsizei) void;
